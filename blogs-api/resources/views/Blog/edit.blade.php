            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr /> -->
                        <form class="needs-validation" enctype="multipart/form-data" novalidate action="{{url('/blog/update',[$BlogData->id])}}" method="POST">
                            <!-- {{csrf_field()}} -->
                            @csrf
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    <label class="form-control-label" for="validationCustom01">Title</label>
                                    <input type="text" class="form-control" id="validationCustom01" name="title" placeholder="Title" value="{{$BlogData->title}}" required>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02" name="body" placeholder="Body" value="{{$BlogData->body}}" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
